...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `reservations_trigger` BEFORE DELETE ON `reservations` FOR EACH ROW BEGIN
		UPDATE seats 
...
-- Dump completed on 2020-04-08 15:38:59
